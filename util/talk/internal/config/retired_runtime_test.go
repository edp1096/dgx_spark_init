	...
	for _, id := range []string{"flash-next-exl3", "qwen27", "qwen27-gguf", "qwen27-exl3"} {
		for _, renamed := range []bool{false, true} {
			...
			t.Run(name, func(t *testing.T) {
				...
				if cfg.Model.DefaultModel != "local-inference-lab/Qwen3.8-Flash-Next-NVFP4" || cfg.Model.ModelType != "qwen3.8" || cfg.Context.WindowTokens != 1048576 || cfg.Model.ReasoningEffort != "medium" {
