...
2026-09-13 후속: FLUX의 pinned-memory를 끈 trial4는 전체 추가 피크 11.86GiB를 기록했다. LoRA 3종·LanPaint 출력 동일성과 반복 전환 결과는 [후속 실측](flux-lora-memory/README.md)에 정리했다. 아래 표는 변경 전 설정의 기록이다.
