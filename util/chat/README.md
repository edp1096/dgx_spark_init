...
설정의 **기억** 탭에서 사용자 정보와 오래 유지할 기억을 직접 등록·수정·중지할
수 있습니다. 현재 질문과 관련 있는 과거 대화는 SQLite FTS 검색으로 찾아 제한된
토큰 안에서만 모델에 전달합니다. 사용자 기억은 항상 우선하며, 과거 대화 회수는
별도로 끌 수 있습니다.
...
해당 내용을 바로 보관할 수도 있습니다. 모델은 안정적인 사용자
선호나 재사용할 사실만 기억 후보로 제안할 수 있으며, 화면에서 사용자가 승인하기
