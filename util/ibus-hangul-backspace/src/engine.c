...
ibus_hangul_init (IBusBus *bus)
{
    ...
    settings_hangul = g_settings_new ("org.freedesktop.ibus.engine.hangul-backspace");
                                      ...
                                      guint          prop_state)
{
    if (strcmp(prop_name, "setup") == 0) {
        ...
        argv[0] = LIBEXECDIR "/hangul-backspace-setup";
        argv[1] = NULL;
                  ...
                  gpointer      user_data)
{
    ...
    if (strcmp (schema_id, "org.freedesktop.ibus.engine.hangul-backspace") == 0) {
