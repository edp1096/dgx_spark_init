...
class Setup ():
    def __init__ (self, bus):
        self.__bus = bus
        self.__settings = Gio.Settings(schema="org.freedesktop.ibus.engine.hangul-backspace")
        ...
        icon_file = os.path.join(config.pkgdatadir, "icons", "hangul-backspace.svg")
...
if __name__ == "__main__":
    ...
    GLib.set_prgname("hangul-backspace")
    GLib.set_application_name("hangul-backspace")
