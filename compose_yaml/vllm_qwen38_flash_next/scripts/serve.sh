...
#   docker logs -f vllm-qwen38-flash-next     # wait for "Application startup complete"
#
# Tunables (env):
...
#   IMAGE=dgx-vllm-qwen38-flash-next:sm121
#   MODEL=dealignai/Qwen3.8-Flash-Next-ABLITERATED-NVFP4
set -euo pipefail

NAME="${NAME:-vllm-qwen38-flash-next}"
IMAGE="${IMAGE:-dgx-vllm-qwen38-flash-next:sm121}"
