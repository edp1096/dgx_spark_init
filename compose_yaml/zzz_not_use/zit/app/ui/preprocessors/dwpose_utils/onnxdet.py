"""YOLOX person detection via cv2.dnn (ONNX model).

Adapted from VideoX-Fun/comfyui/annotator/dwpose_utils/onnxdet.py
...
def inference_detector(session, oriImg, detect_classes=[0]):
    """Run YOLOX detection. Session must be a cv2.dnn.Net object."""
    input_shape = (640, 640)
