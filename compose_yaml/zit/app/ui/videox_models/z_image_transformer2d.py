...
# Removed: videox_fun.dist (multi-GPU parallel), xfuser dependencies.
# All multi-GPU code paths replaced with single-GPU no-ops.
...
class ZImageTransformer2DModel(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        # Single-GPU only: no sequence parallelism
    ...
    def enable_multi_gpus_inference(self):
        """No-op for single-GPU deployment. Multi-GPU parallel (dist module) removed."""
        pass
    ...
    def forward(
        ...
        # Single-GPU: no Context Parallel splitting
        ...
        # Single-GPU: no all_gather needed
